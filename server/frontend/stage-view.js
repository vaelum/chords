// AUTO-GENERATED from stage-view.jsx by server/scripts/build-frontend.js — do not edit.
...
function StageView({
  ...
  const following = !session ? '' : controllerIsMe ? 'your other device' : session.controllerName;
  const parsedLines = useMemoST(() => window.IT.parseSong(song && song.body || ''), [song && song.body]);
  ...
  }, [now && now.since, now && now.line, now && now.song && now.song.id, playing, speed, session && session.at]);
  ...
  useEffectST(() => {
    ...
    const tick = ts => {
      ...
      if (a.playing) {
        ...
        if (diff > DRIFT_LINES) line += Math.min(diff - DRIFT_LINES, dt * pace * CATCHUP);else if (diff < -BACK_JUMP) line = want; // the leader went back on purpose
  ...
  if (!session) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "stage-head-text"
    }, /*#__PURE__*/React.createElement("div", {
      className: "stage-title"
    }, title))), /*#__PURE__*/React.createElement(Empty, {
      icon: "broadcast",
      title: "Session ended",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "stage-title"
  }, song ? song.title : title), /*#__PURE__*/React.createElement("div", {
    className: "stage-sub"
  }, song && song.artist ? /*#__PURE__*/React.createElement("span", null, song.artist, " \xB7 ") : null, /*#__PURE__*/React.createElement("span", {
    className: "stage-following"
  }, "Following ", following), song && !playing ? /*#__PURE__*/React.createElement("span", {
